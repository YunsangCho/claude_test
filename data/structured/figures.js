...
const RAW_IMG = [
/* ── 석탑 ── */
[9,"익산 미륵사지 석탑","석탑","이 석탑의 이름으로 옳은 것은?",
 _pagoda([[92,70,22],[84,62,16],[74,54,13],[64,46,11]],96,0),
 "현존하는 우리나라 최고의 석탑이다. 목탑 양식을 돌로 옮긴 형태여서 지붕돌이 넓고 층이 낮다"],
[9,"부여 정림사지 5층 석탑","석탑","이 석탑의 이름으로 옳은 것은?",
 _pagoda([[70,34,16],[62,30,11],[55,26,9],[48,22,8],[42,19,7]],56,1),
 "지붕돌이 얇고 넓게 뻗어 안정된 비례를 보인다. 백제 사비기를 대표하는 5층 석탑이다"],
[9,"분황사 모전석탑","석탑","이 석탑의 이름으로 옳은 것은?",
 `<svg viewBox="0 0 100 160" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="132" width="80" height="12" fill="var(--ink-soft)"/>
 <g fill="var(--ink)"><rect x="20" y="86" width="60" height="46"/><rect x="26" y="62" width="48" height="22"/><rect x="32" y="42" width="36" height="18"/></g>
 <g stroke="var(--surface)" stroke-width="1">${[90,96,102,108,114,120,126].map(y=>`<line x1="20" y1="${y}" x2="80" y2="${y}"/>`).join('')}
 ${[66,72,78].map(y=>`<line x1="26" y1="${y}" x2="74" y2="${y}"/>`).join('')}${[46,52,58].map(y=>`<line x1="32" y1="${y}" x2="68" y2="${y}"/>`).join('')}</g>
 <g fill="var(--accent)"><rect x="16" y="82" width="68" height="4"/><rect x="22" y="58" width="56" height="4"/><rect x="28" y="38" width="44" height="4"/></g>
 <circle cx="14" cy="127" r="4" fill="var(--accent)"/><circle cx="86" cy="127" r="4" fill="var(--accent)"/></svg>`,
 "돌을 벽돌 모양으로 다듬어 쌓은 모전석탑이다. 선덕여왕 때 세워졌고 기단 네 모서리에 사자상이 있다"],
[9,"감은사지 3층 석탑","석탑","이 석탑의 이름으로 옳은 것은?",
 _pagoda([[76,44,22],[64,36,15],[54,30,12]],84,1),
 "이중 기단 위에 세운 웅장한 3층 석탑이다. 문무왕을 기려 신문왕이 완성했으며 쌍탑으로 세워졌다"],
[9,"불국사 3층 석탑","석탑","이 석탑의 이름으로 옳은 것은?",
 _pagoda([[62,32,17],[52,26,12],[44,22,10]],66,1),
 "석가탑이라고도 한다. 군더더기 없는 비례로 통일 신라 석탑의 전형을 보여 주며 무구정광대다라니경이 발견되었다"],
[9,"다보탑","석탑","이 석탑의 이름으로 옳은 것은?",
 `<svg viewBox="0 0 100 160" xmlns="http://www.w3.org/2000/svg"><rect x="12" y="140" width="76" height="10" fill="var(--ink-soft)"/>
 <rect x="20" y="112" width="60" height="28" fill="var(--ink)"/>
 <g stroke="var(--surface)" stroke-width="2"><line x1="38" y1="112" x2="38" y2="140"/><line x1="62" y1="112" x2="62" y2="140"/></g>
 <rect x="16" y="104" width="68" height="8" fill="var(--accent)"/>
 <g fill="var(--ink)"><rect x="26" y="84" width="48" height="20"/></g>
 <g stroke="var(--surface)" stroke-width="1.5"><line x1="34" y1="84" x2="34" y2="104"/><line x1="50" y1="84" x2="50" y2="104"/><line x1="66" y1="84" x2="66" y2="104"/></g>
 <rect x="22" y="78" width="56" height="6" fill="var(--accent)"/>
 <polygon points="34,78 50,62 66,78" fill="var(--ink)"/>
 <rect x="30" y="56" width="40" height="6" fill="var(--accent)"/>
 <circle cx="50" cy="48" r="7" fill="none" stroke="var(--ink)" stroke-width="3"/>
 <rect x="48.5" y="30" width="3" height="14" fill="var(--ink-soft)"/><circle cx="50" cy="28" r="3.5" fill="var(--accent)"/></svg>`,
 "네 방향 계단과 난간, 팔각 상층부를 갖춘 독창적인 탑이다. 불국사에서 석가탑과 마주 서 있다"],
[15,"평창 월정사 8각 9층 석탑","석탑","이 석탑의 이름으로 옳은 것은?",
 _pagoda([[48,26,12],[46,24,10],[44,23,9],[42,22,9],[40,21,8],[38,20,8],[36,19,7],[34,18,7],[32,17,6]],52,1),
 "송의 영향을 받은 다각 다층 석탑이다. 가늘고 높게 올라간 8각 9층 형태가 특징이다"],
[15,"개성 경천사지 10층 석탑","석탑","이 석탑의 이름으로 옳은 것은?",
 `<svg viewBox="0 0 100 160" xmlns="http://www.w3.org/2000/svg"><rect x="14" y="144" width="72" height="8" fill="var(--ink-soft)"/>
 <g fill="var(--ink)"><polygon points="24,130 34,130 34,124 42,124 42,130 58,130 58,124 66,124 66,130 76,130 76,144 24,144"/>
 <polygon points="26,116 36,116 36,110 44,110 44,116 56,116 56,110 64,110 64,116 74,116 74,130 26,130"/>
 <polygon points="28,102 38,102 38,96 46,96 46,102 54,102 54,96 62,96 62,102 72,102 72,116 28,116"/></g>
 <g fill="var(--ink)">${[[34,88],[36,76],[38,64],[40,54],[42,45],[44,37],[45,30]].map((p,i)=>`<rect x="${(100-(64-i*6))/2}" y="${p[1]}" width="${64-i*6}" height="${9-i*0.5}"/>`).join('')}</g>
 <g fill="var(--accent)">${[[68,86],[62,74],[57,62],[52,52],[47,43],[42,35],[38,28]].map(p=>`<rect x="${(100-p[0])/2}" y="${p[1]}" width="${p[0]}" height="3"/>`).join('')}</g>
 <circle cx="50" cy="24" r="3.5" fill="var(--accent)"/></svg>`,
 "원의 영향을 받은 대리석 탑이다. 아래 3층은 아자형 평면이고 화려한 조각이 새겨져 있으며 조선의 원각사지 10층 석탑으로 이어진다"],
